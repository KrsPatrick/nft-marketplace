...
const NftItem: FunctionComponent <NftListProps> = ({item}) => {
            ...
            <div className="overflow-hidden mb-4">
                ...
                <div className="flex flex-col px-4 pt-4">
                    ...
                    <div className="flex justify-center items-center">
                        100
                        <img className="h-6" alt="eth icon" src="/small-eth.webp"/>
                    </div>
                    </dd>
                </div>
                {
                   item.attributes.map(attribute => {
                    return <div key={attribute.trait_type} className="flex flex-col px-4 pt-4">
